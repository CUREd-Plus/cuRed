...
DESCRIPTION = """
This script takes the TOS Excel workbook as an input and generate a YAML file that contains validation rules.
"""

USAGE = """
python . "my_tos_file.xlsx" -s "HES APC TOS" > apc_rules.yaml
"""
