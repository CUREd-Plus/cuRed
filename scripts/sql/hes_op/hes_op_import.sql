...
-- Appointment date
ALTER TABLE hes_op ADD COLUMN IF NOT EXISTS appointment_year USMALLINT;
UPDATE hes_op SET appointment_year = YEAR(apptdate);
ALTER TABLE hes_op ADD COLUMN IF NOT EXISTS appointment_month VARCHAR;
UPDATE hes_op SET appointment_month = STRFTIME(apptdate, '%Y-%m');
